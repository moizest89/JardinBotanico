...
import com.moizest89.jbplandelalaguna.Util.TouchImageView;
 ...
 */
public class TipGalleryImagesAdaptaer extends PagerAdapter{
    ...
    public TipGalleryImagesAdaptaer(Context context,List<String> mData ) {
